...
BEGIN
	...
	DECLARE @rowInsertedID int;

	SET @rowInsertedID = IDENT_CURRENT('Addresses');

	INSERT INTO dbo.Properties (UserID, Valuation, LowestPrice, Prop_Address_ID)
	values (@UserID, @Valuation, @LowestPrice, @rowInsertedID);
